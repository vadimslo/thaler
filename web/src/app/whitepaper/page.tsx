...
const PLACEHOLDER = `The whitepaper is being written. It will cover the currency, the charter system, the central bank's policy rule, the flow hook, the treasury, and the full parameter table for testnet and mainnet. Until then, the mechanism is summarised on the home page and every live parameter is on the protocol page.`;
